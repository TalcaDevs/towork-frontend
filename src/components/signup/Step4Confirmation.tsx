  ...
  useEffect(() => {
    ...
    const submitProfile = async () => {
      ...
      try {
        ...
        setSubmissionError(errorMessages.serverError);
      } finally {
      ...
      {isSubmitting ? (
        ...
        <>
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Tu perfil ha sido enviado para revisión. Te notificaremos por email
            cuando sea aprobado y puedas acceder a tu portafolio CV.
          </motion.p>
